...
class JobReceiptWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final customer = jobData.customerDetails;
    final device = jobData.device.isNotEmpty ? jobData.device[0] : null;
    final services = jobData.services;
    final defect = jobData.defect.isNotEmpty ? jobData.defect[0] : null;
