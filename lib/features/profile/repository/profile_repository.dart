...
class ProfileRepository {
  Future<ProfileResponseModel> getProfile() async {
    ...
    try {
      ...
      debugPrint('📊 [ProfileRepository] Response status: ${response.statusCode}');
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint('❌ [ProfileRepository] Failed with status: ${response.statusCode}');
      ...
      if (e.response != null) {
        debugPrint('📊 [ProfileRepository] Response status: ${e.response?.statusCode}');
        throw ProfileException(message: 'Server error: ${e.response?.statusCode}', statusCode: e.response?.statusCode);
      } else {
  ...
  Future<String> getImageUrl(String imagePath) async {
    return await FileService.getImageUrlAsync(imagePath);
  }
