...
class _JobBookingStartBookingJobScreenState extends State<JobBookingStartBookingJobScreen> {
  ...
  Future<void> _addNewBrand(String brandName) async {
    ...
    await context.read<BrandCubit>().getBrands(userId: _userId); // Ensure we have the list
              ...
              slivers: [
                SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 8.h),
                      JobBookingTopBar(stepNumber: 1, onBack: _handleBack),
                    ...
                    child: BlocBuilder<BrandCubit, BrandState>(
                      builder: (context, state) {
                        if (state is BrandLoading) {
                          return SizedBox(height: 60.h, child: Center(child: CupertinoActivityIndicator()));
                        }
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          SizedBox(width: 16.w, height: 16.h, child: CupertinoActivityIndicator(radius: 8)),
                          SizedBox(width: 8.w),
