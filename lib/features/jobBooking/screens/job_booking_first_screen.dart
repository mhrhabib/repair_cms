...
class _JobBookingFirstScreenState extends State<JobBookingFirstScreen> {
  ...
  void _addService(ServiceModel service) {
    ...
    context.read<JobBookingCubit>().addService(service);
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: CustomTextButton(onPressed: () => Navigator.of(context).pop(), text: 'Close'),
                      ),
                    ),
                ...
                builder: (context, state) {
                  if (state is JobBookingData && state.job.servicesIds.isNotEmpty && _searchController.text.isEmpty) {
                    ...
                    return SliverList(
                      ...
                      }, childCount: state.selectedServices.length),
                    );
                  }
