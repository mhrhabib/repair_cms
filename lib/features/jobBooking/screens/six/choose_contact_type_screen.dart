...
class ChooseContactTypeScreen extends StatefulWidget {
  ...
  @override
  State<ChooseContactTypeScreen> createState() =>
      _ChooseContactTypeScreenState();
}
...
class _ChooseContactTypeScreenState extends State<ChooseContactTypeScreen> {
  ...
  void _navigateToNextScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => JobBookingAddressScreen(
          isNewProfile: !isExistingProfileSelected,
                          ...
                          Container(
                            ...
                            child: BlocConsumer<ContactTypeCubit, ContactTypeState>(
                              ...
                              builder: (context, state) {
                                if (_isSearching &&
                                    state is! ContactTypeSearchResult) {
                                ...
                                if (state is ContactTypeSearchResult) {
                                  ...
                                  final hasExactMatch = searchResults.any((
                                    profile,
                                  ) {
                                    final name =
                                        '${profile.firstName ?? ''} ${profile.lastName ?? ''}'
                                            ...
                                            .toLowerCase();
                                    final org =
                                        profile.organization?.toLowerCase() ??
                                        '';
                                    return org ==
