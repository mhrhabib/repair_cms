...
class SetUpDI {
  ...
  Future<void> init() async {
    ...
    // Splash cubit
    _getIt.registerFactory<SplashCubit>(
      () => SplashCubit(profileRepository: _getIt<ProfileRepository>()),
    );
    ...
    _getIt.registerFactory<CompanyCubit>(
      () => CompanyCubit(companyRepository: _getIt<CompanyRepository>()),
    );
    ...
    _getIt.registerLazySingleton<JobBookingFileUploadRepository>(
      () => JobBookingFileUploadRepositoryImpl(),
    );
    _getIt.registerFactory<JobFileUploadCubit>(
      () => JobFileUploadCubit(
        fileUploadRepository: _getIt<JobBookingFileUploadRepository>(),
      ),
    );
    ...
    _getIt.registerLazySingleton<JobReceiptRepository>(
      () => JobReceiptRepositoryImpl(),
    );
