...
class AppColors {
  static const Color primary = Color(0xFF2589F6);
  static const Color fontMainColor = Color(0xFF253053);
  static const Color fontSecondaryColor = Color(0xFF4F5E7B);
  static const Color secondary = Color(0xFFD9D9D9);
  static const Color scaffoldBackgroundColor = Color(0xFFF0F3F7);
